...
String sql = " update student set name = ? where  num = ?"; //Statement 형태

PreparedStatement pstmt = con.prepareStatement(sql);

pstmt.setInt(2, num); //첫번째 물음표 값
pstmt.setString(1, name); //두번째물음표, 값
...
//update student set name ='홍길순' where num=1;
//update student set name = ?       where num = ?
